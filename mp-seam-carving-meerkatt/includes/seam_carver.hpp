...
public:
  ...
  // helpers for GetEnergy member function
  int findColorVal(std::string color, Pixel up, Pixel low) const;
  int findSumVal(Pixel up, Pixel low) const;
  ...
  int findMinPathVert(int** values) const;
  int findMinPathHorz(int** values) const;
